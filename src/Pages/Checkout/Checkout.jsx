...
import congratulation from "../../assets/success.json";
          ...
          <div className="">
            <div className="w-full max-w-sm p-6 m-auto mx-auto form-section text-white rounded-md shadow-md dark:bg-gray-800">
              ...
              <div className="flex items-center justify-between mt-4">
                ...
                <span className="text-xs text-center text-white uppercase dark:text-gray-400 hover:underline"></span>

                <span className="w-1/5 border-b dark:border-gray-400 lg:w-1/5"></span>
              </div>

              <div className="flex ml-2 flex-col justify-center items-center max-w-xs p-6 shadow-md rounded-xl sm:px-12 dark:bg-gray-900 dark:text-gray-100">
                <img
                  src={user.photoURL}
                  alt=""
